...
public class FacultyController {
    ...
    public ResponseEntity<Collection<Faculty>> findFacultyByColour(@RequestParam("colour") String colour) {
        return ResponseEntity.ok(facultyService.findFacultyByColour(colour));
    }
